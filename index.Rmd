...
inversiones <- read_csv("inversiones.csv")
...
plot.inversiones <- function(inversiones, año){
  ...
  layout(title = paste("Inversiones", año), yaxis = list(categoryorder = "total descending", title = ""), showlegend = FALSE, xaxis = list(showgrid=T, zeroline=T, nticks=20, showline=F, tickprefix = '€', tickformat=",.2r", hoverformat = '.2f'))
}
